  ...
  implements OnGatewayInit, OnGatewayConnection, OnGatewayDisconnect
{
  ...
  async handleConnection(client: SocketWithAuth) {
    ...
    // updated all sockets in the room
  ...
  async handleDisconnect(client: SocketWithAuth) {
    ...
    if (updatedPoll) {
      // if someone disconnected, updated all sockets in the room
  ...
  async removeParticipant(
    ...
    this.logger.debug(
      `Attempting to remove participant with id ${id} from poll ${client.pollID}`
    );
